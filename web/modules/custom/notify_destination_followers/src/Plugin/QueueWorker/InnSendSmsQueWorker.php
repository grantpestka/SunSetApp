 ...
 *
 * @QueueWorker(
 *   id = "notify_sms_queue_worker",
 *   title = @Translation("SMS Notification Queue Worker"),
 *   cron = {"time" = 15}
 * )
 */
class NotifySmsQueueWorker extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    ...
    $this->notifyUtility->sendSms($booking);
  }
